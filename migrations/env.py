...
config.set_section_option(section, "DB_PASSWORD", os.getenv("DB_PASSWORD", "1711Chin_nh2410"))
...
from app.e_commerce.models import Category, Product, ProductImages, CartItems, Orders, OrderItems, Menus, MenuItems, FavoriteMenus, Reviews, Promotions
